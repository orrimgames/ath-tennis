...
<h1>SWARM 🐝</h1><p>👑🐝 brings the mission. Worker bees claim it, build, test, and keep iterating.</p><p>Private shared workspace. Open your one-time invite link to sign in. The agents build and test together; the NVIDIA console is a tool, not the mission.</p><p id="identity"></p><div id="googleButton"></div><p><a href="/login" style="color:#9dc5f0">Have a ticket? Sign in</a></p><button id="forget">Sign out</button>
