...
Fn.add(Ls);
const Da = "./assets/unitree_h1_2/",
  Ac = [
    "left_ankle_pitch_link.STL", "left_ankle_roll_link.STL", "left_elbow_link.STL",
    "left_hip_pitch_link.STL", "left_hip_roll_link.STL", "left_hip_yaw_link.STL", "left_knee_link.STL",
    "left_shoulder_pitch_link.STL", "left_shoulder_roll_link.STL", "left_shoulder_yaw_link.STL",
    "left_wrist_pitch_link.STL", "left_wrist_roll_link.STL", "logo_link.STL", "pelvis.STL",
    "right_ankle_pitch_link.STL", "right_ankle_roll_link.STL", "right_elbow_link.STL",
    "right_hip_pitch_link.STL", "right_hip_roll_link.STL", "right_hip_yaw_link.STL", "right_knee_link.STL",
    "right_shoulder_pitch_link.STL", "right_shoulder_roll_link.STL", "right_shoulder_yaw_link.STL",
    "right_wrist_pitch_link.STL", "right_wrist_roll_link.STL", "torso_link.STL", "wrist_yaw_link.STL",
...
async function ZE() {
  try {
    let Y = function (ie, Q) {
      ...
      he = function (ie, Q) {
        ...
        for (let Ke = 0; Ke < Re; Ke++) {
          // H1-2's group 0 geoms are collision shells; render only group 1 visuals.
    ...
    ((bc.textContent = "Compiling official Unitree H1-2 model…"),
      document.querySelector("#loadbarfill") &&
    ...
    ((J.castShadow = !0),
      ...
      (document.querySelector("#geo").textContent =
        `${a.nmesh} official H1-2 meshes ×2`),
